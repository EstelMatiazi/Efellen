	...
	public class ElementalFiendWater : BaseCreature
	{
		...
		public override void OnThink()
		{
			if ( Core.SE && Summoned )
			{
				...
				{
					if ( m is SummonDireBear || m is SummonSnakes || m is ElementalFiendWater || m is GasCloud || m is DeathVortex || m is SummonedTreefellow || m is EnergyVortex || m is SummonDragon || m is SummonPhoenix || m is SummonDireBear )
					{
