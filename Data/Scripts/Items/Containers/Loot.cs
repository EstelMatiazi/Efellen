		...
		private static Type[] m_ArtyTypes = new Type[]
			{
				...
				typeof( Artifact_VampireKiller ), 	typeof( Artifact_CapOfTheFallenKing ), 	typeof( Artifact_EarringsOfHealth ), 	typeof( Artifact_GlovesOfDexterity ), 	typeof( Artifact_HolySword ), 	typeof( Artifact_LeggingsOfBane ), 	typeof( Artifact_NightsKiss ), 	typeof( Artifact_RingOfTheElements ), 	typeof( Artifact_TunicOfAegis ), 	typeof( Artifact_MantleofHydros ),
