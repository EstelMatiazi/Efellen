		...
		private static Type[] m_ArtyTypes = new Type[]
			{
				...
				typeof( Artifact_ArcaneArms ), 	typeof( Artifact_BlightGrippedLongbow ), 	typeof( Artifact_CoifOfFire ), 	typeof( Artifact_EssenceOfBattle ), 	typeof( Artifact_GlovesOfThePugilist ), 	typeof( Artifact_HuntersHeaddress ), 	typeof( Artifact_LegsOfInsight ), 	typeof( Artifact_OrcChieftainHelm ), 	typeof( Artifact_RobeOfTreason ), 	typeof( Artifact_VampiricDaisho ), 	typeof( Artifact_RobeofPyros ),
				...
				typeof( Artifact_ArcaneLeggings ), 	typeof( Arty_BookOfKnowledge ), 	typeof( Artifact_ConansLoinCloth ), 	typeof( Artifact_FalseGodsScepter ), 	typeof( Artifact_CloakOfTheRogue ), 	typeof( Artifact_InquisitorsArms ), 	typeof( Artifact_LieutenantOfTheBritannianRoyalGuard ), 	typeof( Arty_OssianGrimoire ), 	typeof( Artifact_RoyalArchersBow ), 	typeof( Artifact_StitchersMittens ), 	typeof( Artifact_WildfireBow ), 	typeof( Arty_LithosTome ),
