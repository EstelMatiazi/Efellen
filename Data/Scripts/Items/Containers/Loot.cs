		...
		private static Type[] m_ArtyTypes = new Type[]
			{
				...
				typeof( Artifact_ArcaneLeggings ), 	typeof( Arty_BookOfKnowledge ), 	typeof( Artifact_ConansLoinCloth ), 	typeof( Artifact_CloakOfTheRogue ), 	typeof( Artifact_InquisitorsArms ), 	typeof( Artifact_LieutenantOfTheBritannianRoyalGuard ), 	typeof( Arty_OssianGrimoire ), 	typeof( Artifact_RoyalArchersBow ), 	typeof( Artifact_StitchersMittens ), 	typeof( Artifact_WildfireBow ), 	typeof( Arty_LithosTome ),
				...
				typeof( Artifact_ArcaneTunic ), 	typeof( Artifact_BootsofHermes ), 	typeof( Artifact_CrimsonCincture ), 	typeof( Artifact_GrimReapersMask ), 	typeof( Artifact_InquisitorsHelm ), 	typeof( Artifact_LuckyEarrings ), 	typeof( Artifact_Pacify ), 	typeof( Artifact_RoyalGuardsGorget ), 	typeof( Artifact_Subdue ), 	typeof( Artifact_WizardsPants ), 	
				typeof( Artifact_ArcanicRobe ), 	typeof( Artifact_BowOfTheTribalKing ), 	typeof( Artifact_CrownOfTalKeesh ), 	typeof( Artifact_FeyLeggings ), 	typeof( Artifact_GrimReapersRobe ), 	typeof( Artifact_InquisitorsLeggings ), 	typeof( Artifact_LuckyNecklace ), 	typeof( Artifact_PadsOfTheCuSidhe ), 	typeof( Artifact_RoyalGuardSurvivalKnife ), 	typeof( Artifact_SwiftStrike ), 	typeof( Artifact_WrathOfTheDryad ), 	
				...
				typeof( Artifact_WintersGrip ), 	typeof( Artifact_BraceletOfHealth ), 	typeof( Artifact_DarkGuardiansChest ), 	typeof( Artifact_Fortifiedarms ), 	typeof( Artifact_GuantletsOfAnger ), 	typeof( Artifact_InquisitorsTunic ), 	typeof( Artifact_HolyLance ), 	typeof( Artifact_Pestilence ), 	typeof( Artifact_SamaritanRobe ), 	typeof( Artifact_TheBeserkersMaul ), 	typeof( Artifact_ZyronicClaw ), 	
