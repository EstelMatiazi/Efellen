...
{
	public class Penitent : BaseCreature 
	{
		private static Dictionary<Mobile, DateTime> m_LastHealTime = new Dictionary<Mobile, DateTime>();

		[Constructable] 
		public Penitent() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
		...
		public Penitent( Serial serial ) : base( serial ) 
		{ 
		} 
		...
		public override bool OnBeforeDeath()
		{
		    if (this.Map != null && this.Map != Map.Internal)
		    {
		        ...
		        {
		            mobileCount++;
		            if (m is DaughterOfFire && m.Alive)
		            {
		                DaughterOfFire prince = (DaughterOfFire)m;
		                DateTime lastHeal;
        ...
        public void EquipMetalGear()
        {
            ...
            {
                case 0: this.AddItem(new BattleAxe { Hue = 0xb73 }); break;
                case 1: this.AddItem(new Halberd { Hue = 0xb73 }); break;
                case 2: this.AddItem(new DoubleAxe { Hue = 0xb73 }); break;
                case 3: this.AddItem(new ExecutionersAxe { Hue = 0xb73 }); break;
                case 4: this.AddItem(new WarAxe { Hue = 0xb73 }); break;
                case 5: this.AddItem(new TwoHandedAxe { Hue = 0xb73 }); break;
                case 6:
                    this.AddItem(new VikingSword { Hue = 0xb73 });
                    if (Utility.Random(3) == 1) { shield.Hue = 0xb73; this.AddItem(shield); }
                    break;
                case 7:
                    this.AddItem(new ThinLongsword { Hue = 0xb73 });
                    if (Utility.Random(3) == 1) { shield.Hue = 0xb73; this.AddItem(shield); }
                    break;
                case 8:
                    this.AddItem(new Longsword { Hue = 0xb73 });
                    if (Utility.Random(3) == 1) { shield.Hue = 0xb73; this.AddItem(shield); }
                    break;
                case 9:
                    this.AddItem(new Broadsword { Hue = 0xb73 });
                    if (Utility.Random(3) == 1) { shield.Hue = 0xb73; this.AddItem(shield); }
                    break;
            }
            Robe robe = new Robe
